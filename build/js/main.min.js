...
},{"./modules/audio-player":2,"./modules/form-validate/form":4,"./modules/menu":10,"./modules/video-player":11,"./utils/ios-vh-fix":13}],2:[function(require,module,exports){
"use strict";

var audioContainer = document.querySelector('.audio-player');
var audioButton = audioContainer.querySelector('.audio-player__button-play');
function onButtonPlayAudio() {
  ...
  var audioPlayer = document.createElement('iframe');
...
var placeholder = videoContainer.querySelector('img');
